...
class AuditLogServiceTest {
    ...
    private static AuditLogQuery query(String sourceApp) {
        return AuditLogQuery.parse(sourceApp, null, null, null, null, null, null);
    }

    @Test
    void scopedCredentialIsConfinedToItsOwnAppEvenWithNoParam() {
        service.query(AuthenticatedClient.boundTo("continuum", SourceApp.CONTINUUM_HOME), query(null));

        assertThat(capture().sourceApp()).contains(SourceApp.CONTINUUM_HOME);
    }
    ...
    void scopedCredentialMayRedundantlyNameItsOwnApp() {
        service.query(AuthenticatedClient.boundTo("continuum", SourceApp.CONTINUUM_HOME), query("continuum-home"));
    ...
    void limitIsClampedToTheConfiguredCeiling() {
        service.query(AuthenticatedClient.crossApp("api-key"),
                AuditLogQuery.parse(null, null, null, null, null, null, 99_999));
    ...
    void nextBeforeIsSetOnlyWhenThePageCameBackFull() {
        ...
        AuditLogPage full = service.query(AuthenticatedClient.crossApp("api-key"),
                AuditLogQuery.parse(null, null, null, null, null, null, 50));
